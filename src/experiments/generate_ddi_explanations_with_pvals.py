...
class PromptConfig:
    ...
    demo_template: str = "<image>\nThe lesion is {label}.\n\n"
    query_template: str = "<image>\nThe lesion is"
...
def run_single_seed_experiment(config_dict, df_preprocessed, random_seed, shared_data=None):
    ...
    seed_dir = results_dir / f'seed_{random_seed}_oldprompt'
...
def main():
    ...
    base_config = {
        ...
        'metadata_path': 'your/path/here/to/ddidiversedermatologyimages/ddi_metadata.csv',
        'ddi_base_dir': "your/path/here/to/ddi/ddidiversedermatologyimages/",
        'concept_files': ['your/path/here/to/concept_sets/google-10000-english-no-swears.txt',
                          'your/path/here/to/concept_sets/skincon.txt'],
